...
# =====================================================================
# === 1. GELİŞMİŞ BUTONLU ÇEKİLİŞ SİSTEMİ ===
# =====================================================================
...
# =====================================================================
# === 2. GÖRESELDEKİ ONAY / RED SİSTEMLİ ROL BAŞVURUSU ===
# =====================================================================
...
class RolBasvuruView(View):
    ...
    async def sunucu_sahibi(self, interaction: discord.Interaction, button: discord.Button): await interaction.response.send_modal(RolBasvuruModal("Sunucu Sahibi"))
    @discord.ui.button(label="Klan Sahibi", style=discord.ButtonStyle.primary, emoji="⚔️", custom_id="basvuru_klan_sahibi")
    async def klan_sahibi(self, interaction: discord.Interaction, button: discord.Button): await interaction.response.send_modal(RolBasvuruModal("Klan Sahibi"))
    @discord.ui.button(label="Hosting Sahibi", style=discord.ButtonStyle.primary, emoji="💻", custom_id="basvuru_hosting_sahibi")
    async def hosting_sahibi(self, interaction: discord.Interaction, button: discord.Button): await interaction.response.send_modal(RolBasvuruModal("Hosting Sahibi"))
    @discord.ui.button(label="İçerik Üreticisi", style=discord.ButtonStyle.primary, emoji="🎬", custom_id="basvuru_icerik_ureticisi")
    async def icerik_ureticisi(self, interaction: discord.Interaction, button: discord.Button): await interaction.response.send_modal(RolBasvuruModal("İçerik Üreticisi"))

# =====================================================================
# === 3. TICKET (DESTEK TALEP) SİSTEMİ ===
# =====================================================================
...
async def slash_cekilis(interaction: discord.Interaction, süre: str, ödül: str, kazananlar: int = 1):
    ...
    if 'BANNER_URL' in globals() and BANNER_URL.startswith("http") and not BANNER_URL.endswith("..."): embed.set_thumbnail(url=BANNER_URL)
